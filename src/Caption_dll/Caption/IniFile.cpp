...
static string iniFileARIB   = "cc_gaiji.ini";
static string iniFileARIBU  = "UNICODE_cc_gaiji.ini";
static string iniFileARIB2  = "cc_gaiji2.ini";
static string iniFileARIB2U = "UNICODE_cc_gaiji2.ini";
